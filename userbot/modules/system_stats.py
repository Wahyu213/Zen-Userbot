...
async def bot_ver(event):
    ...
    if which("git") is not None:
        ...
        await event.edit(
            "**⚜-**⚡Zen-Userbot⚡ Versi:** \n "
            f"heads/Zen-Userbot-0-x634i7u1"
            "\n**⚜-**Revisi:**\n "
            f"{revout}"
        )
    else:
...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╰✠╼━━━━━━━━━━━━━━━✠╯\n"
        f"[ɢʀᴏᴜᴘꜱ](https://t.me/OkaeriUserbot) | [ʙᴏᴛᴏꜰ](https://t.me/{user.username}) | [ɢɪᴛʜᴜʙ](https://github.com/Wahyu213/Zen-Userbot)"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def redis(alive):
    ...
    output = (
        ...
        f"┃✧ **GitHub   :** [UserBot](https://github.com/Wahyu213/Zen-userbot) \n"
        f"┃✧ **Owner    :** [Zen](https://t.me/zenfrans) \n"
        f"┃✧ **support  :** [groups](https://t.me/OkaeriUserbot) \n"
        f"╰✠╼━━━━━━━━━━━━━━━━✠╯"
    )
    if ALIVE_LOGO:
        try:
...
CMD_HELP.update(
    {
        "alive": "𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.alive` or `.on` or `zen`"
