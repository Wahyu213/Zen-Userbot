...
REPOLINK = (
    ...
    else "https://github.com/Wahyu213/Zen-Userbot"
)
# ============================================
...
async def killdabot(event):
    ...
    await event.edit("**Mematikan Zen-Userbot....**")
...
async def killdabot(event):
    await event.edit("**Restarting Zen-Userbot...**")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[⚡ Zen-UserBot Repo](https://github.com/Wahyu213/Zen-Userbot/blob/Zen-userBot/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "**Usᴇʀʙᴏᴛ Tᴇʟᴇɢʀᴀᴍ**\n"
        "𝗥𝗲𝗽𝗼 🇮🇩\n"
        "╰⎆ [𝐙𝐄𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​](https://github.com/Wahyu213/Zen-userbot)\n"
        "❏ **Oᴡɴᴇʀ​** ⎆ [Zen](t.me/zenfrans)\n"
        "❏ **Sᴜᴘᴘᴏʀᴛ**​ ⎆ [groups](t.me/OkaeriUserbot)\n"
    )
