...
PMPERMIT_PIC = (
    ...
    or "https://telegra.ph/file/d61f9ac1d3deee23a77b7.jpg"
)
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "Zen-UserBot")
...
with bot:
    try:
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    f"❁ __Saya Adalah Zen Userbot Yang Digunakan Banyak User Telegram__.\n\n"
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    ...
                    f"× **Pembaruan Data Untuk 𝐙𝐄𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​, Command Untuk Pembaruan**.\n"
                    f"⚒Pembaruan Data :\n"
                    f"`.update deploy`\n"
                    f"`update`\n\n"
                    f"© @OkaeriUserbot")
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                ...
                await event.edit(
                    ...
                    link_preview=True,
                    buttons=[
                        [Button.url("ᴄʜᴀɴɴᴇʟ", "t.me/nbzoning")],
                    ],
                )
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith(""):
                ...
                result = builder.article(
                    "Bantuan Dari **⚡𝐙𝐄𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​⚡**",
                    text="Daftar Plugins",
                    buttons=[],
                    link_preview=True,
                )
            else:
                result = builder.article(" **⚡𝐙𝐄𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​⚡**",
                                         text="""°𝐙𝐄𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓°""",
                                         buttons=[[custom.Button.url("okaeri​",
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # userbot
                ...
                await event.edit(
                    ...
                    buttons=[
                        [
                            Button.url("❈ꜱᴜᴘᴘᴏʀᴛ❈", "t.me/OkaeriUserbot"),
                            Button.url("❈ᴄʜᴀɴɴᴇʟ❈", "t.me/nbzoning"),
                        ],
                        [custom.Button.inline(
